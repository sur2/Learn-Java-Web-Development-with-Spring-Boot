...
import info.thecodinglive.Chapter05Application;
import info.thecodinglive.model.User;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = Chapter05Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
